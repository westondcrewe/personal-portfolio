      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8">
        ...
        <div className="flex flex-col justify-center text-center md:text-left flex-grow bg-white/90 rounded-xl shadow-lg p-8 max-w-3xl">
          ...
          <p className="text-lg text-gray-700 mb-6">
            ...
            hands dirty with Next.js web app development, but I also see it as 
            a fun way to engage with recruiters and other new professional connections! 
            I am eager to join a highly dynamic team where I'm challenged to grow a 
            holistic technical and professional skillset by working across the stack, 
            collaborating cross-functionally, and gaining hands-on experience with 
            the full product lifecycle. Feel free to reach out and we'll get in touch!
          </p>
